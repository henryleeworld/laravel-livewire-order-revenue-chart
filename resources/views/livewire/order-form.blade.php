<div>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            {{ $editing ? __('Edit Order') : __('Create Order') }}
        </h2>
    </x-slot>
            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form wire:submit="save">
                        ...
                        <table class="mt-4 min-w-full border divide-y divide-gray-200">
                            <thead>
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('Product') }}</span>
                                </th>
                                <th class="px-6 py-3 text-left bg-gray-50">
                                    <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('Quantity') }}</span>
                                </th>
                        ...
                        <div class="mt-3">
                            <x-primary-button wire:click="addProduct" type="button">+ {{ __('Add Product') }}</x-primary-button>
                        </div>
                        {{-- End Order Products --}}
