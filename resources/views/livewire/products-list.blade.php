            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-4">
                        ...
                        <x-primary-button wire:click="export('csv')">{{ __('CSV') }}</x-primary-button>
                        <x-primary-button wire:click="export('xlsx')">{{ __('XLSX') }}</x-primary-button>
                        <x-primary-button wire:click="export('pdf')">{{ __('PDF') }}</x-primary-button>
                    </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th wire:click="sortByColumn('products.name')"
                                        ...
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Name') }}</span>
                                    ...
                                    <th class="px-6 py-3 text-left bg-gray-50">
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Categories') }}</span>
                                    </th>
                                    <th wire:click="sortByColumn('countryName')" class="px-6 py-3 text-left bg-gray-50">
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Country') }}</span>
                                    ...
                                    <th wire:click="sortByColumn('price')" class="w-32 px-6 py-3 text-left bg-gray-50">
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Price') }}</span>
                                        @if ($sortColumn == 'price')
                                            @include('svg.sort-' . $sortDirection)
                                        @else
                                            @include('svg.sort')
