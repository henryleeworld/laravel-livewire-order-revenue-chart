                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th wire:click="sortByColumn('order_date')" class="px-6 py-3 w-40 text-left bg-gray-50">
                                        <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('Order date') }}</span>
                                    ...
                                    <th class="px-6 py-3 text-left bg-gray-50">
                                        <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('User Name') }}</span>
                                    </th>
                                    <th class="px-6 py-3 text-left bg-gray-50 w-fit">
                                        <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('Products') }}</span>
                                    </th>
                                    <th wire:click="sortByColumn('subtotal')" class="px-6 py-3 w-36 text-left bg-gray-50">
                                        <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('Subtotal') }}</span>
                                    ...
                                    <th wire:click="sortByColumn('taxes')" class="px-6 py-3 w-32 text-left bg-gray-50">
                                        <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('Taxes') }}</span>
                                        @if ($sortColumn == 'taxes')
                                            @include('svg.sort-' . $sortDirection)
                                        @else
                                            @include('svg.sort')
                                    ...
                                    <th wire:click="sortByColumn('total')" class="px-6 py-3 w-32 text-left bg-gray-50">
                                        <span class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">{{ __('Total') }}</span>
                                        @if ($sortColumn == 'total')
                                            @include('svg.sort-' . $sortDirection)
                                        @else
                                            @include('svg.sort')
                                ...
                                <tr>
                                    ...
                                    <td class="px-1 py-1 text-sm">
                                        <input wire:model="searchColumns.username" type="text" placeholder="{{ __('Search') }}..."
                                               class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                                    </td>
                                    <td class="px-1 py-1">
                                    </td>
