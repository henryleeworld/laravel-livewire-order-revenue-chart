                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th wire:click="sortByColumn('order_date')"
                                        ...
                                        <span class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Order date') }}</span>
                                    ...
                                    <th class="px-6 py-3 text-left bg-gray-50">
                                        <span class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('User Name') }}</span>
                                    </th>
                                    <th class="px-6 py-3 text-left bg-gray-50 w-fit">
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Products') }}</span>
                                    </th>
                                    <th wire:click="sortByColumn('subtotal')"
                                        class="px-6 py-3 text-left w-36 bg-gray-50">
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Subtotal') }}</span>
                                    ...
                                    <th wire:click="sortByColumn('taxes')" class="w-32 px-6 py-3 text-left bg-gray-50">
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Taxes') }}</span>
                                        @if ($sortColumn == 'taxes')
                                            @include('svg.sort-' . $sortDirection)
                                        @else
                                            @include('svg.sort')
                                    ...
                                    <th wire:click="sortByColumn('total')" class="w-32 px-6 py-3 text-left bg-gray-50">
                                        <span
                                            class="text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase">{{ __('Total') }}</span>
                                        @if ($sortColumn == 'total')
                                            @include('svg.sort-' . $sortDirection)
                                        @else
                                            @include('svg.sort')
